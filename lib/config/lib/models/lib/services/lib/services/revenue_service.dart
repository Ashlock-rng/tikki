...
class RevenueService {
  ...
  /// When someone buys a Boost → you (platform) get 100% of the money
  Future<void> processBoostPayment({
    ...
    // You (platform) keep 100% of boost money
    // (You can later move this to a platform_wallet collection)
